...
#define NODE_MAIN_LOGGER_NAME "aichallenge_scoring_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libaichallenge_scoring.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<aichallenge_scoring::AIChallengeScoringNode>";
